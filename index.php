            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <?php 
                        ...
                        $post_per_page=3;
                        $page_start_from=($page-1)*3;

                        $select_post      ="SELECT * FROM post ORDER BY post_id DESC LIMIT $page_start_from, $post_per_page";
                    ...
                    <div class="paginetion">
                        <ul>
                            <!-- Next Button -->
                            <?php 
                                 $select_post_paginetion    ="SELECT * FROM post";
                                 $select_post_paginetion_sql=mysqli_query($db, $select_post_paginetion);
                                 $count_post_paginetion     =mysqli_num_rows($select_post_paginetion_sql);
                                 $total_page = ceil($count_post_paginetion/$post_per_page);
                                 if ($page>1) {
                                     // code...
                                    echo "<li class='blog-prev'><a href='index.php?page=".($page-1)."'><i class='fa fa-long-arrow-left'></i>Previous</a></li>";
                                 }
                                 ...
                                 if ($page <$total_page) {
                                     // code...
                                    echo "<li class='blog-next'><a href='index.php?page=".($page+1)."'>Next<i class='fa fa-long-arrow-right'></i></a></li>";
                                 }
