                ...
                <div class="col-md-8">
                    <?php 
                        if (isset($_POST['search'])) {
                            ...
                            $blog_search      ="SELECT * FROM post WHERE post_tittle LIKE '%$search_keyword%' OR post_des LIKE '%$search_keyword%' ORDER BY post_id DESC";
                            $blog_search_query=mysqli_query($db, $blog_search);
                            $count_posts      =mysqli_num_rows($blog_search_query);
                            if ($count_posts<=0) {
                                // code...
                                echo "<div class='alert alert-danger'>
                                        Opps There is No Post in This Search Result
                                    </div>";
                            }

                            while ($row=mysqli_fetch_assoc($blog_search_query)) {
                                // code...
                                  $post_id    =$row['post_id'];
